...
<script>
import { saveContent, getContent, getPaymentItemList, getCityList } from '@/api/social'
...
export default {
  ...
  computed: {
    ...
    timeOfEntry() { // 时间格式化
      return dayjs(this.sizeForm.user.timeOfEntry).format('YYYY-MM-DD')
    },
    dutyStatusTxt() { // 在职离职的转换
