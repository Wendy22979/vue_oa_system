      ...
      <div class="itemDropDown">
        <div class="topLab">
          ...
          <div class="rightLabBox">
            ...
            <el-button size="small" type="primary" @click="archivingReportForm">归档{{ yearVal }}报表</el-button>
          </div>
        </div>
        <el-table
          :data="contentData"
...
<script>
import { getArchivingCont, getArchivingArchive } from '@/api/social'
...
export default {
  ...
  computed: {
    yearVal() { // 路由传参带过来的年月日
      return this.$route.query.yearMonth
    }
  },
  mounted() {
  ...
  methods: {
    ...
    // 归档报表
    archivingReportForm() {
      this.$confirm(`您确定要归档${this.yearVal}报表？报表归档将覆盖上一次归档记录，无法恢复。`, '', {
